...
'''
10/22/2024  This is the third test which I ran in London to replicate prior results. We did not have MD&A 
data onboarded yet so I'm switching to using the regular 10K/10Q data which is up through April of this year.

* It keeps the short cutoff at 0.5 to prevent shorting.  
* This will update the Deception & Truth data and price data through March or mayb later.
...
def create_backtest_settings(args):
    ...
    print(f'testing cutoffs: {cutoffs}')
...
def run_single_backtest(BacktestSetting, delay_interval):
    ...
    """
    print(f'Starting settings: {Backtest_Setting}')
